(() => {
  ...
  const freshState = () => ({
    ...
    chain:{version:'7.9.1',flags:{},log:[],perfect:0,renown:0,lastApplied:{}},
  ...
  function closeModal(){modalRoot.innerHTML='';}
    function openReleaseNotes(){openModal('v7.9.1 修正內容',`<ul><li>修正章回判斷題標題顯示 undefined</li><li>修正 A／B／C 選項顯示 [object Object]</li><li>支援新舊兩種判斷題資料格式</li><li>修正選擇後紀錄、成功判定與結果文字</li><li>保留 v7.9.0 的安全更新、快取診斷、遠征賽季與章回連鎖功能</li></ul><div class="actions"><button class="btn" data-modal="close">關閉</button><button class="btn primary" data-act="ops">前往維護中心</button></div>`);}
