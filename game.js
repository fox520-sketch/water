(() => {
  ...
  function openReleaseNotes(){openModal('v7.8.0 更新內容',`<ul><li>第 73～108 回補齊手工劇情，108 回全章回皆有三方案、判斷與多重結局</li><li>108 英雄第三輪平衡，正常觀察區提升到 92 名</li><li>遠征視覺地圖、隱藏事件、遺物組合與 8 種專屬首領獎勵</li><li>雲端合併細項勾選、合併後預覽與版本還原提醒</li><li>裝備自動分解規則實際套用，副屬性與套裝篩選更完整</li><li>新手推薦隊伍、推薦配點、卡關提示與七日任務</li><li>NVDA／VoiceOver／TalkBack 驗收紀錄表與已修正項目</li><li>重要英雄與首領立繪精修資產</li><li>正式部署診斷結果頁與 GitHub Pages / Firebase 實機驗收流程</li></ul><div class="actions"><button class="btn" data-modal="close">關閉</button></div>`);}
